...
enum ACTION
{
	ACTION_NONE = 1,
	ACTION_JUMP = 1 << 1,
	ACTION_SLASH_ATTACK = 1 << 2,
	ACTION_THROW_ATTACK = 1 << 3,
	ACTION_RUN = 1 << 4,
	ACTION_CHARGE = 1 << 5,
	ACTION_BACKDASH = 1 << 6,
	ACTION_DASH = 1 << 7,
...
enum ATTACKTYPE
{
	...
	ATTACK_PLAYER_THROW_LEFT,
	ATTACK_PLAYER_THROW_RIGHT,
	ATTACK_ERI_WAVE_LEFT,
	ATTACK_ERI_WAVE_RIGHT,
	ATTACK_ERI_KNIVES
};
